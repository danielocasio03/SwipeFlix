...
class SwipeViewController: UIViewController {
	...
	var containerTopConstant: CGFloat = 0
	var containerBottomConstant: CGFloat = -110
	var containerTrailConstant: CGFloat = 0
	var containerLeadConstant: CGFloat = 0
	...
	func setupContainerView() {
		...
		containerView.backgroundColor = UIColor(red: 10/255, green: 10/255, blue: 10/255, alpha: 0.7)
		...
		NSLayoutConstraint.activate([
			...
			//DISMISS BUTTON
			dismissButton.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 50),
